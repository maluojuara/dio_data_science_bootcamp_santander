...
CREATE TABLE users (
	id INT COMMENT 'Unique user identifier',
...
CREATE TABLE reservations (
	id INT COMMENT 'Unique reservation identifier',
	user_id INT NOT NULL UNIQUE COMMENT 'ID of the user who made that reservation',
	destination_id INT COMMENT 'Reference to reservation destination ID',
	reserv_status VARCHAR(50) DEFAULT 'pending' UNIQUE COMMENT 'Status of the reservation (pending, cancelled, confirmed etc)'
);

CREATE TABLE destinations (
	id INT COMMENT 'Unique destination identifier',
